class Lines3d extends VertexGroup3d {
  constructor(glCntxt, shader, matrixMath4x4, camera, colorUniformKey, posAttributeKey, matrixUniformKey, color4fv, vertices3fv) {
    if (color4fv === undefined && vertices3fv === undefined) {
      ...
      super(glCntxt, shader, matrixMath4x4, camera, colorUniformKey, posAttributeKey, matrixUniformKey, color4fv, vertices3fv)
      if (color4fv.length < 4) {
        this.errorLog("color data must be of the type 4fv")
      }
...
class LineStrip3d extends VertexGroup3d {
  constructor(glCntxt, shader, matrixMath4x4, colorUniformKey, posAttributeKey, matrixUniformKey, color4fv, vertices3fv) {
    if (color4fv === undefined && vertices3fv === undefined) {
      super(glCntxt, shader, matrixMath4x4, camera, colorUniformKey, posAttributeKey, matrixUniformKey)
    } else if (vertices3fv === undefined) {
      super(glCntxt, shader, matrixMath4x4, camera, colorUniformKey, posAttributeKey, matrixUniformKey, color4fv)
